...
router.get('/api/movies/seen', (req, res) => {
...
router.get('/api/movies/watchlist', (req, res) => {
...
router.get('/api/movies/search/:title', (req, res) => {
...
router.post('/api/movies/seen', (req, res) => {
  Movie.create({
...
router.post('/api/movies/watchlist', (req, res) => {
  Movie.create({
    title: req.body.title,
    movie_id: req.body.movie_id,
    seen: false,
...
router.put('/api/movies/seen/:id', (req, res) => {
